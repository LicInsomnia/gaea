 ...
 * 需要缓存合并的实体
 **/
public abstract class AbstractCacheReorganizationCsvAnalysis implements ReorganizationLineMultiAnalysis{
    ...
    protected AbstractCacheReorganizationCsvAnalysis(@NotNull Class<MergeAble>... clazz) {
