...
public class QQData extends AbstractSrcData {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), qq,caseTags,macOuter,completeSession,source, capTime, userId, serverId, proName, protocol, clientMac, serverMac, clientIp, serverIp, clientPort, serverPort, clientIpOuter, serverIpOuter, clientPortOuter, serverPortOuter, protocolOuter, imp, malformedUpPayload, malformedDownPayload, imsi, imei, msisdn, dataType, groupName, targetName, upPkt, upByte, downPkt, downByte, duration, syn, fin, foreign, eventData, caseTags);
    }
