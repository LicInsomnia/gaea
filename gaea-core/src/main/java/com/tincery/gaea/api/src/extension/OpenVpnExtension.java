...
@Getter
@Setter
public class OpenVpnExtension extends SslExtension {
    ...
    public void merge(OpenVpnExtension openVpnExtension) {
        ...
        this.clientCerChain = (List<String>) SourceFieldUtils.mergeField(this.clientCerChain, openVpnExtension.clientCerChain);
        ...
        this.serverCerChain = (List<String>) SourceFieldUtils.mergeField(this.serverCerChain, openVpnExtension.serverCerChain);
