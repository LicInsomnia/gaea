...
//
//        private final Function<AssetConfigDO.BlackOrWhiteList, AssetConfigDO.OutInputFilter> function;
//
//
...
//
//        // 判断是否命中
//        private final BiPredicate<JSONObject, AssetConfigDO.OutInputFilter> biPredicate;
//
//        // 告警素材是如何由规则和资产产生的
//        private final BiFunction<JSONObject, AssetConfigDO, AlarmMaterialData> createAlarmFunction;
//
