...
@Setter
@Getter
public class EmailReceiver extends AbstractSrcReceiver<EmailProperties, EmailData> {
    ...
    protected void putCsvMap(EmailData emailData) {
        ...
        for (EmailData email : split) {
            ...
            appendCsvData(emailData.getDateSetFileName(ApplicationInfo.getCategory()),
    ...
    @Override
    public long analysisFile(List<String> lines) {
